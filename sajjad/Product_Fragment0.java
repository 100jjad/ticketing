...
public class Product_Fragment0 extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static Product_Fragment0 newInstance(int page_position) {
        Product_Fragment0 fragment = new Product_Fragment0();
        return fragment;
    }
...
//        fbn_scroll_to_top = v.findViewById(R.id.floatactionbutton);
        ...
        int count_child = category_list_in_viewpager.get(product_position).getChild_count();


        if (flag_category) {
            loader.setVisibility(View.VISIBLE);
            get_category_list(category_list_in_viewpager.get(0).getCategory_id());
...
//                if(rcv.getLayoutManager() != null)
//                {
//                    rcv.getLayoutManager().startSmoothScroll(smoothScroller);
//                }
//
//            }
//        });
